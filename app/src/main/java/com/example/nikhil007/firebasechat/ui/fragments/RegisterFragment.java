package com.example.nikhil007.firebasechat.ui.fragments;
...
import com.example.nikhil007.firebasechat.core.registration.RegisterContract;
import com.example.nikhil007.firebasechat.core.registration.RegisterPresenter;
import com.example.nikhil007.firebasechat.core.users.add.AddUserContract;
import com.example.nikhil007.firebasechat.core.users.add.AddUserPresenter;
import com.example.nikhil007.firebasechat.ui.activities.UserListingActivity;
...
public class RegisterFragment extends Fragment implements View.OnClickListener, RegisterContract.View, AddUserContract.View {
    ...
    private void onRegister(View view) {
        ...
        if(emailId.equals("") || password.equals("")){
            Toast.makeText(getActivity(),"please Fill EmailId or Password",Toast.LENGTH_SHORT).show();
        }
        else {
